...
function go() {
    ...
    if (ipversion == "localhost") {
            ...
            SocketTLS = tls.connect({
                ...
                function main() {
                    ...
                    for (let i = 0; i < ratelimit; i++) {
                        ...
                        var useragent = `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36`;
                        ...
                        var lang = "ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7";
                        var mobile = "?0";
                        if (streamId == 1) {
        ...
        }).once('error', (err) => { console.log(err); }).once('close', () => {
            if (SocketTLS) {
